package com.aty.ecom.order.infrastructure.secondary.entity;

import com.aty.ecom.order.domain.user.aggregate.Authority;
import com.aty.ecom.order.domain.user.aggregate.AuthorityBuilder;
import com.aty.ecom.order.domain.user.vo.AuthorityName;
